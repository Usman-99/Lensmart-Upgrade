        ...
        <div className="w3-col l3 m6 w3-margin-bottom">
          <div className="w3-card">
            ...
            <div className="w3-container">
              ...
              <br />
              <p className="bg-light px-2 py-2"><b>CEO &amp; Founder</b></p>
              <br />
              <p>
        ...
        <div className="w3-col l3 m6 w3-margin-bottom">
          <div className="w3-card">
            ...
            <div className="w3-container">
              ...
              <br />
              <p className="bg-light px-2 py-2"><b>Manager</b></p>
              <br />
              <p>
                Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse
                sodales pellentesque elementum.
              ...
              <br />
              <p className="w3-button w3-light-grey w3-block">
                <i className="fa fa-phone" />
                +92333469876
              </p>
              <br />
        ...
        <div className="w3-col l3 m6 w3-margin-bottom">
          <div className="w3-card">
            ...
            <div className="w3-container">
              ...
              <br />
              <p className="bg-light px-2 py-2"><b>Digital Manager</b></p>
              <br />
              <p>
                Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse
                sodales pellentesque elementum.
        ...
        <div className="w3-col l3 m6 w3-margin-bottom">
          <div className="w3-card">
            ...
            <div className="w3-container">
              ...
              <br />
              <p className="bg-light px-2 py-2"><b>Marketing Manager</b></p>
              <br />
              <p>
                Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse
                sodales pellentesque elementum.
